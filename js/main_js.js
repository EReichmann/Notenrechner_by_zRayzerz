...
function notenfelder_auslesen() {
    ...
    document.getElementById("ausgabe").innerHTML = ergebnis_notenpunkte

    if (note_1<0 || note_1>15){                                                                                          //Trennung der Variablen voneinander durch "||"
        document.getElementById("ausgabe").innerHTML = "keine gültige Anzahl";
        console.log("Bitte geben sie einen Wert zwischen 0 und 15 ein")
    }
    if (note_2<0 || note_2>15){
        document.getElementById("ausgabe").innerHTML = "keine gültige Anzahl";
        console.log("Bitte geben sie einen Wert zwischen 0 und 15 ein")
    }
    if (note_3<0 || note_3>15){
        document.getElementById("ausgabe").innerHTML = "keine gültige Anzahl";
        console.log("Bitte geben sie einen Wert zwischen 0 und 15 ein")
    }
    if (note_4<0 || note_4>15){
        document.getElementById("ausgabe").innerHTML = "keine gültige Anzahl";
        console.log("Bitte geben sie einen Wert zwischen 0 und 15 ein")
    }
    if (note_5<0 || note_5>15){
        document.getElementById("ausgabe").innerHTML = "keine gültige Anzahl";
        console.log("Bitte geben sie einen Wert zwischen 0 und 15 ein")
    }
                                                                                                                        //Ausgabe der Notenpunkte im index.html
